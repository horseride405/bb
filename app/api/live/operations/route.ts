...
export async function GET(request: Request) {
  ...
  const [policyResult, accountsResult, approvalsResult, intentsResult, snapshotsResult, auditResult] = await Promise.all([
    supabase
      .from("risk_policies")
  ...
  if (policyResult.error || accountsResult.error || approvalsResult.error || intentsResult.error || snapshotsResult.error || auditResult.error) {
